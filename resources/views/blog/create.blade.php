     ...
     <div class="w-4/5 m-auto">
       <ul>
           @foreach ($errors->all() as $error )
               <li class="w-1/5 mb-4 text-gray-50
               bg-red-700 rounded-2xl py-4">
                   {{ $error }}
                </li>
           @endforeach 
       </ul>
...
<div class="w-4/5 m-auto pt-20">
   ...
   <div class="bg-grey-lighter pt-15">
       <label class="w-44 flex flex-col items-center px-2 py-3
        ...
        border-blue cursor-pointer">
         <span class="mt-2 mb-15 text-base leading-normal">
              select a file
         </span>
         <input 
         type="file"
   ...
   <button
      type="submit"
      class="uppercase mt-20 bg-blue-500 text-gray-100 text-lg
